...
import com.tapstream.downloader.repository.UnsupportedContentException
...
/**
 * BubbleService with Hilt Dependency Injection
 * 
 * Now uses injected VideoRepository for proper lifecycle management
 */
@AndroidEntryPoint
class BubbleService : Service() {
    ...
    // Video download components - injected by Hilt
    @Inject
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        if (intent?.action == "com.tapstream.downloader.ACTION_DOWNLOAD") {
